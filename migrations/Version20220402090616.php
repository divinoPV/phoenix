 ...
 */
final class Version20220402090616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fact (uuid VARCHAR(255) NOT NULL, milestone_id VARCHAR(255) NOT NULL, project_id VARCHAR(255) NOT NULL, occurred DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_6FA45B954B3E2EDA (milestone_id), INDEX IDX_6FA45B95166D1F9C (project_id), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `member` (id INT AUTO_INCREMENT NOT NULL, team_id VARCHAR(255) DEFAULT NULL, type_id VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_70E4FA78E7927C74 (email), INDEX IDX_70E4FA78296CD8AE (team_id), INDEX IDX_70E4FA78C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member_type (uuid VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, color VARCHAR(7) NOT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE milestone (uuid VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, placement VARCHAR(255) NOT NULL, mandatory TINYINT(1) NOT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE status (uuid VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, placement INT NOT NULL, slug VARCHAR(255) DEFAULT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE team (uuid VARCHAR(255) NOT NULL, responsible_id INT NOT NULL, parent_id VARCHAR(255) DEFAULT NULL, type_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_C4E0A61F602AD315 (responsible_id), INDEX IDX_C4E0A61F727ACA70 (parent_id), INDEX IDX_C4E0A61FC54C8C93 (type_id), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE team_type (uuid VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `member` ADD CONSTRAINT FK_70E4FA78C54C8C93 FOREIGN KEY (type_id) REFERENCES member_type (uuid)');
        ...
        $this->addSql('ALTER TABLE team ADD CONSTRAINT FK_C4E0A61FC54C8C93 FOREIGN KEY (type_id) REFERENCES team_type (uuid)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `member` DROP FOREIGN KEY FK_70E4FA78C54C8C93');
